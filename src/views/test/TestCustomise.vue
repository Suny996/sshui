<template>
  <Customise @customises="c=>customise=c" :defaultFields="defaultFields">
    <el-form :model="formItem" ref="formValidate" :rules="ruleValidate" label-width="120" label-position="right">
      <el-row>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" v-show="customise.name">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6" v-show="customise.gender">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6" v-show="customise.date">
          <el-form-item label="Date" prop="date">
            <el-date-picker type="date" v-model="formItem.date"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="8" :lg="6" v-show="customise.city">
          <el-form-item label="City" label-for="city" prop="city"  label-width="120">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6" v-show="customise.mail">
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="6">
          <el-form-item :label="$t('switchLangTitle')">
            <el-radio-group :value="lang" @on-change="handleSwitch" vertical>
